(ns guadalete-ui.core
  ...
  (:require
    ...
    [guadalete-ui.fx.modal-fx]
    [guadalete-ui.events.boot]
    [guadalete-ui.events.modal]
    [guadalete-ui.events.mouse]
    [guadalete-ui.events.node]
    [guadalete-ui.events.pd]
    [guadalete-ui.events.pd.nodes]
...
(defn- mount-root [] (reagent/render [views/main-panel] (by-id "main")))
